...
if (isset($_POST['autor_da_ obra'])  && isset($_POST['editora_do_manga']) && isset($_POST['numerro_do_codigo_do_manga']) && isset($_POST['ano_de_publicacao'])) {
    $nome = $_POST['autor_da_obra'];
    $editora = $_POST['editora_do_manga'];
    $codigo = $_POST['numerro_do_codigo_do_manga'];
...
if ($resultado_verifica->fetch_row()[0] > 0) {
    ...
    $sql = "INSERT INTO cadastro do produto (autor_da_obra, editora_do_manga, numerro_do_codigo_do_manga, ano_de_publicacao,) VALUES ('$autor_da_obra', '$editora_do_manga' , '$numerro_do_codigo_do_manga' , '$ano_de_publicacao')";
