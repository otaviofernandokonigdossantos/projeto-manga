...
--
-- Host: localhost:3306
-- Tempo de geração: 05-Ago-2024 às 11:00
...
CREATE TABLE `cadastro do produto` (
  `autor da obra` varchar(100) NOT NULL,
  `editora do manga` varchar(100) NOT NULL,
  `numerro de codigo do manga` int NOT NULL,
  `ano de publicacao` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
ALTER TABLE `cadastro do produto`
  ADD PRIMARY KEY (`numerro de codigo do manga`);
...
--
ALTER TABLE `cadastro do produto`
  MODIFY `numerro de codigo do manga` int NOT NULL AUTO_INCREMENT;
